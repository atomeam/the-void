...
>(({ className, children, side = "bottom", ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 bg-surface shadow-[var(--shadow-border)] p-5",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        side === "bottom" &&
          "inset-x-0 bottom-0 rounded-t-xl data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom pb-[max(1.25rem,env(safe-area-inset-bottom))]",
        side === "right" &&
          "inset-y-0 right-0 h-full w-[min(100%,22rem)] rounded-l-xl data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
        className,
      )}
      {...props}
    >
